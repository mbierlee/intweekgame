...
namespace IntWeekGame
{
	public class Player
	{
		...
		private SoundEffect soundCarCrash;
		private SoundEffect soundGameOver;
		private SoundEffect soundStreetLight;
		private SoundEffect soundTrashcan;
		private SoundEffect soundCoffee;
		...
		public void LoadContent()
		{
			...
			soundCarCrash = IntWeekGame.GameInstance.Content.Load<SoundEffect>("Audio/CarCrash");
			soundGameOver = IntWeekGame.GameInstance.Content.Load<SoundEffect>("Audio/GameOver");
			soundStreetLight = IntWeekGame.GameInstance.Content.Load<SoundEffect>("Audio/StreetLight");
			soundTrashcan = IntWeekGame.GameInstance.Content.Load<SoundEffect>("Audio/Trashcan");;
			soundCoffee = IntWeekGame.GameInstance.Content.Load<SoundEffect>("Audio/Coffee");
		}
